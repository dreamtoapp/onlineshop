    ...
    return (
        ...
        >
            <div className="relative w-full aspect-square bg-muted">
                ...
                {rank !== undefined && (
                    <span className="absolute top-2 right-2 bg-primary text-white text-xs font-bold px-2 py-0.5 rounded-full shadow">
                        #{rank + 1}
                    </span>
                )}
            </div>
            <div className="p-3">
                ...
                <Link href={`/product/${slug}`} className="mt-2 inline-block w-full text-center bg-primary text-white rounded px-3 py-1 font-semibold hover:bg-primary/90 transition">
                    عرض المنتج
                </Link>
            </div>
        </div>
